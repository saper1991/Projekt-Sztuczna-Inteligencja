...
func_exp --> add(Za), func_exp, {concat_atom([Za], Z)}.

func_exp --> sub(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> div(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> mul(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> inc(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> dec(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> if(Za),func_exp, {concat_atom([Za], Z)}.

func_exp --> declaration(Za),func_exp,  {concat_atom([Za], Z)}.
