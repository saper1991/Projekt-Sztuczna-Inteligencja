...
%test loop
test_loop(D) --> petla_loop(Loop,0),{concat_atom([Loop],D)}.
%testfloat
...
funkcja_nagl(FN) --> "Function", odstep_k, nazwa(Nazwa), odstep, !, "(", parametry(Parametry), ")", !, odstep, "As", odstep_k, typ(Typ), nl_k, !, {concat_atom([Typ,' ',Nazwa, '(', Parametry, ')'],FN), info(FN)}.
...
%petla Loop
petla_loop(L,Wci) --> petla_loop_1(L, Wci).
petla_loop(L,Wci) --> petla_loop_2(L, Wci).
petla_loop_1(L, Wci) --> {info('Do while?\n')}, "Do", odstep_k, "While",{info('Do while!\n')}, odstep_k, warunek(War), nl_k, {Wci1 is Wci+1}, petla_loop_1_cialo(Cialo,Wci1), {wciecie(W,Wci), concat_atom([W, 'while ', War,'\n',W,'{\n',Cialo,W,'}\n'],L)}.
petla_loop_1(L, Wci) --> {info('Do while?\n')}, "Do", odstep_k, "Until",{info('Do while!\n')}, odstep_k, warunek(War), nl_k, {Wci1 is Wci+1}, petla_loop_1_cialo(Cialo,Wci1), {wciecie(W,Wci), concat_atom([W, 'while (!', War,')\n',W,'{\n',Cialo,W,'}\n'],L)}.
petla_loop_2(L, Wci) --> {info('Do while?\n')}, "Do", nl_k, {Wci1 is Wci+1}, petla_loop_2_cialo(Cialo,Wci1), odstep_k, petla_loop_2_warunek(War), nl_k, {wciecie(W,Wci), concat_atom([W, 'do {\n',Cialo,W,'} while ', War,';\n'],L)}.
petla_loop_2_warunek(LW) --> "Until",{info('Do while!\n')}, odstep_k, warunek(War), {concat_atom(['(!', War,')'],LW)}.
petla_loop_2_warunek(LW) --> "While",{info('Do while!\n')}, odstep_k, warunek(LW).
%petla_loop_2(L, Wci) --> {info('Do while?\n')}, "Do", nl_k, {Wci1 is Wci+1}, petla_loop_2_cialo(Cialo,Wci1), odstep_k, "While",{info('Do while!\n')}, odstep_k, warunek(War), nl_k, {wciecie(W,Wci), concat_atom([W, 'do {\n',Cialo,W,'} while ', War,';\n'],L)}.
petla_loop_1_cialo('',_) --> {info('Loop?\n')}, "Loop", {info('Loop!\n')}, nl_k.
petla_loop_1_cialo(LC,Wci) --> {info('Loop cialo?\n')}, petla_loop_cialo(LC1,Wci), {info('Loop cialo!\n')}, petla_loop_1_cialo(LC2,Wci), {concat_atom([LC1,LC2],LC)}.
petla_loop_2_cialo('',_) --> {info('Loop?\n')}, "Loop", {info('Loop!\n')}.
petla_loop_2_cialo(LC,Wci) --> {info('Loop cialo?\n')}, petla_loop_cialo(LC1,Wci), {info('Loop cialo!\n')}, petla_loop_2_cialo(LC2,Wci), {concat_atom([LC1,LC2],LC)}.
petla_loop_cialo(E,Wci) --> petla_loop_exit(E,Wci).
petla_loop_cialo(C,Wci) --> petla_loop_continue(C,Wci).
petla_loop_cialo(I,Wci) --> instrukcja(I,Wci).
petla_loop_exit(E,Wci) --> "Exit", odstep_k, "Do", nl_k, {wciecie(W,Wci), concat_atom([W, 'break;\n'],E)}.
petla_loop_continue(C,Wci) --> "Continue", odstep_k, "Do", nl_k, {wciecie(W,Wci), concat_atom([W, 'continue;\n'],C)}.
...
instrukcja(I,Wci) --> petla_loop(I,Wci), {info(' LOOP ')}.
...
przypisanie(P,Wci) --> nazwa(N1), odstep, "=", odstep, "Console.ReadLine()", nl_k, {wciecie(W,Wci), concat_atom([W,'cin>>', N1, ';\n'],P)}.
